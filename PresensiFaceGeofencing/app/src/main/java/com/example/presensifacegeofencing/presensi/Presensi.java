...
import com.example.presensifacegeofencing.config.GeofenceTransitionService;
...
public class Presensi extends AppCompatActivity implements
...
//        -8.174444, 113.716581
        ...
        //-8.175536, 113.718496 -8.184151, 113.721005
        lat2 = -7.060176;
        long2 = 110.468151;
        ...
        System.out.println("Jam : " + today.format("%k:%M:%S"));
        ...
        masuk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "Cek Presensi Masuk...", Toast.LENGTH_LONG).show();
                startGeofence();
        ...
        keluar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "Cek Presensi Keluar...", Toast.LENGTH_LONG).show();
                startGeofence();
...
//
//        editor.putLong( KEY_GEOFENCE_LAT, Double.doubleToRawLongBits(   -8.173850 ));
//        editor.putLong( KEY_GEOFENCE_LON, Double.doubleToRawLongBits( 113.716935));
//        editor.apply();
    }
...
//        Double distance = R * c;
        ...
        int jarak = (int) Math.round(distance);
    ...
    private void Masuk() {
        ...
        final ProgressDialog loading = ProgressDialog.show(getApplicationContext(), "Loading...", " Mohon Tunggu...", false, false);
    ...
    private void Keluar() {
        //menampilkan progress dialog
        final ProgressDialog loading = ProgressDialog.show(getApplicationContext(), "Loading...", " Mohon Tunggu...", false, false);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.URL + "web_service/keluar.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
